...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal form-validation" action="{{ route('vendor.update', $vendor->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                            <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 offset-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="code" value="{{ $vendor->code }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="div1" style="display: none; margin-bottom: 10px;">
                                                        <input type="number" name="invoice_due_date"
                                                            value="{{ $vendor->invoice_due_date }}" class="form-control"
                                                    ...
                                                    <select name="invoice_due_date_unit" id="invoice_due_date_unit"
                                                        ...
                                                        @foreach ($INVOICE_DUE_DATE as $key => $due_date)
                                                            <option value="{{ $key }}"
                                                                {{ $vendor->invoice_due_date_unit == $key ? 'selected' : '' }}>
                                                                {{ $due_date }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="address_line_1"
                                                                value="{{ $vendor->address_line_1 }}" class="form-control"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="address_line_2"
                                                                ...
                                                                class="form-control" id="address_line_2" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="country_code" id="country_code"
                                                                ...
                                                                @foreach ($COUNTRY as $key => $country)
                                                                    <option value="{{ $key }}"
                                                                        {{ $vendor->country_code == $key ? 'selected' : '' }}>
                                                                        {{ $country }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="postal_code"
                                                                value="{{ $vendor->postal_code }}" class="form-control"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="cell"
                                                                value="{{ $vendor->cell }}" class="form-control"
                                                                id="cell" placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fax"
                                                                value="{{ $vendor->fax }}" class="form-control"
                                                                id="fax" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8 offset-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="notes" id="notes" value="{{ $vendor->notes }}">
                                                    </textarea>
                                                </div>
                                            </div>
...
@push('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var invoice_due_date_unit = '{{ $vendor->invoice_due_date_unit }}';
            if (invoice_due_date_unit == 0) {
            ...
            var postal_code = '{{ $vendor->postal_code }}'
            if (postal_code != 0) {
                var address = $("#address_line_1").val()
                $("#address_line_2").val() + ' ' +
                    $("#city").val() + ' ' +
                    $("#state").val() + ' ' +
                    $("#country_code").find(":selected").text() + ' , ' +
                    $("#postal_code").val();
        ...
        $("#summary_cell").html($("#cell").val());

        $("#cell").keyup(function() {
            $("#summary_cell").html($(this).val());
        });

        $("#summary_fax").html($("#fax").val());
