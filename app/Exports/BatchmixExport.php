...
class BatchmixExport implements FromView, WithHeadings, WithColumnWidths, WithStyles, WithDefaultStyles, WithCustomStartCell, WithEvents, WithDrawings, WithTitle
{
    ...
    public function view(): View
    {
        ...
        $batchmix = Batchmix::where([['branch_id', $branch_id], ['period_id', $period_id]])->get();

        self::$count += count($batchmix) * 2;

        return view('admin.report_batchmix.exportexcel', [
            'batchmixs' => $batchmix,
