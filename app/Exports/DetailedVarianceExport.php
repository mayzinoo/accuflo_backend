...
class DetailedVarianceExport implements FromView, WithColumnWidths, WithStyles, WithDefaultStyles, WithCustomStartCell, WithEvents, WithDrawings, WithTitle
{
    ...
    public function view(): View
    {
        ...
        if ((isset($this->excel_category_quality_id) && isset($this->excel_detail_summary_id))) {
            ...
            $item_id = FullCount::select('item_id')
                ...
                ->where('branc$branch_id', $branch_id)
            ...
            if (
                ...
                $this->excel_detail_summary_id == 'Detailed'
            ) {
        ...
        return view('admin.report_variance.detailedexportexcel', [
            'items' => $items,
            'classes' => $classes,
